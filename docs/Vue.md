...
<img align="right" height="130" src="images/Vue.png">
...
* JavaScript
    ...
    <HelloWorld msg="Welcome to Your Vue.js App"/>
    ```
    Саме такий випадок. Він приймає дані через атрибут `msg`. Для опису такої властивості компонента, ці спеціальні атрибути перелічуються у значенні ключа `props`. Це можна зробити у 3 способи:
    * переліком:
        ```javascript
    ...
    * зі вказанням типу прийманих даних та значення за замовчуванням:
        ...
        props: {
            title: {
                type: String,
                default: 'Перші 10 чисел Фібоначчі:'
            },
            sum: {
                type: Number,
                default: 88
    ...
    ```
    Колись давно, нажаль, атрибути посварилися з вусиками, тому їх синтаксис не може бути використаний у значенні атрибута:
    ```html
    <a href="{{ link }}">стаття</a>
...
Інтерактивність сторінки вимагає динамічності компонентів - можливості зміни їх станів.
